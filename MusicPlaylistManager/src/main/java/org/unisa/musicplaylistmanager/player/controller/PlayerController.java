package org.unisa.musicplaylistmanager.player.controller;
...
public class PlayerController implements Initializable {
     ...
     * Attiva la strategia {@link Shuffle} se lo shuffle era inattivo,
     * oppure ripristina la strategia {@link Sequential} se era attivo.
    ...
    public void handleShuffle() {
        ...
        if (isShuffleActive) {
            ...
            player.getIterator().setStrategy(new Sequential());
        }
        updateStrategyUI();
    }
     ...
     * Attiva la strategia {@link Loop} se il loop era inattivo,
     * oppure ripristina la strategia {@link Sequential} se era attivo.
    ...
    public void handleLoop() {
        ...
        if (isLoopActive) {
            ...
            player.getIterator().setStrategy(new Loop());
        } else {
            player.getIterator().setStrategy(new Sequential());
        }
        updateStrategyUI();
