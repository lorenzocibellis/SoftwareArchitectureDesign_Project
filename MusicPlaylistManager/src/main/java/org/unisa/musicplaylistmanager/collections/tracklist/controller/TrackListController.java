package org.unisa.musicplaylistmanager.collections.tracklist.controller;
...
import org.unisa.musicplaylistmanager.track.command.BaseTrackCommands;
...
import org.unisa.musicplaylistmanager.player.service.ActivePlayerManager;
...
import org.unisa.musicplaylistmanager.tag.controller.TagManagerController;
...
import org.unisa.musicplaylistmanager.track.controller.TrackController;
                ...
                if (data.length >= 8) {
                    ...
                    if (data.length >= 9 && !data[8].trim().isEmpty()) {
                        ...
                        for (String tag : tags) {
                            ...
                            PersonalTagManager.getInstance().addTag(trimmedTag);
                        }
                    }
